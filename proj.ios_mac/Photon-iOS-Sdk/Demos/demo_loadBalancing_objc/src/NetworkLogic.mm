...
static bool autoLobbyStats = true;
static bool useDefaultRegion = true;
...
- (NetworkLogic*) initWithOutputListener:(id<OutputListener>)listener :(NSString*)appVersion
{
	...
	mLoadBalancingClient=[[EGLoadBalancingClient alloc] initClient:self :appId :appVersion :PLAYER_NAME :ExitGames::Photon::ConnectionProtocol::UDP :nil :autoLobbyStats :useDefaultRegion];
...
//{
//    EGLOG(EGDbgLvl::INFO, L"onAppStatsUpdate: online: %d, games: %d, in game: %d", mLoadBalancingClient.CountPlayersOnline, mLoadBalancingClient.CountGamesRunning, mLoadBalancingClient.CountPlayersIngame);
//	[mOutputListener writeLine:@"AppStats: %d / %d / %d", mLoadBalancingClient.CountPlayersOnline, mLoadBalancingClient.CountGamesRunning, mLoadBalancingClient.CountPlayersIngame];
//}
