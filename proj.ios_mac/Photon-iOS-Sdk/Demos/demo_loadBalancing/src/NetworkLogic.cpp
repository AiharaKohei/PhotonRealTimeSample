...
void NetworkLogic::opCreateRoom(void)
{
	...
	mLoadBalancingClient.opCreateRoom(tmp=GETTIMEMS(), true, true, 4, ExitGames::Common::Hashtable(), ExitGames::Common::JVector<ExitGames::Common::JString>(), ExitGames::Common::JString(), ExitGames::LoadBalancing::LobbyType::DEFAULT, INT_MAX/2, 10000);
