...
namespace ExitGames
{
	namespace Chat
	{
		...
		Client::Client(Listener& listener, const JString& applicationID, const JString& appVersion, const JString& userId, nByte connectionProtocol, AuthenticationValues authenticationValues)
